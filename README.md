...
Download the data archive from [Zenodo](https://doi.org/10.5281/zenodo.19427673) and place the files in the appropriate directories as described in `ZENODO_MANIFEST.md`.
